                    ...
                    <div class="card-header border-0">
                        ...
                        <div class="card-tools">
                          <ul class="nav nav-pills ml-auto">
                            <li class="nav-item">
                              <a class="nav-link active" href="#snp-chart" data-toggle="tab">Jual - Beli</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" href="#rne-chart" data-toggle="tab">Rev - Expe</a>
                            </li>
                          </ul>
                        </div>
                    </div>
                    <div class="card-body">
                      <div class="tab-content p-0">
                        ...
                        <div class="chart tab-pane active" id="snp-chart" style="position: relative; height: 300px;">
                          <canvas class="chart" id="trans-chart-canvas" style="min-height: 250px; height: 250px; max-height: 300px; max-width: 100%;"></canvas>
                        </div>
                        <div class="chart tab-pane" id="rne-chart" style="position: relative; height: 300px;">
                          <canvas class="chart" id="rne-chart-canvas" style="min-height: 250px; height: 250px; max-height: 300px; max-width: 100%;"></canvas>
                        </div>
                      </div>
                    </div>
                    <!-- /.card-body -->
