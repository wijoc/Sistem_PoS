    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark text-uppercase">Transaksi Pengeluaran</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            <div class="card card-info card-outline">
              <div class="card-header">
                ...
                <a class="btn btn-sm btn-info float-right text-white" data-toggle="modal" data-target="#modal-add-expenses" data-placement="top" title="Tambah Transaksi"> <i class="fas fa-plus"></i></a>
                <?php } ?>
              </div>
              <div class="card-body">
