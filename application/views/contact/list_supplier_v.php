              ...
              <div class="modal-body">
                ...
                <!-- Form-part input Supplier nama -->
                  <div class="form-group row">
                    <label for="inputSuppNama" class="col-sm-4 col-form-label">Nama Supplier <font color="red">*</font><a class="float-right"> : </a></label>
                    <div class="col-sm-8">
                ...
                <!-- Form-part input Supplier nama Kontak-->
                  <div class="form-group row">
                    <label for="inputSuppKontak" class="col-sm-4 col-form-label">Nama Kontak <font color="red">*</font><a class="float-right"> : </a></label>
                    <div class="col-sm-8">
                ...
                <!-- Form-part input Supplier telp -->
                  <div class="form-group row">
                    <label for="inputSuppTelp" class="col-sm-4 col-form-label">No. Telp <a class="float-right"> : </a></label>
                    <div class="col-sm-8">
                      <input type="number" class="form-control float-right" name="postSuppTelp" id="inputSuppTelp" placeholder="Nomor Telephone">
                ...
                <!-- Form-part input Supplier email -->
                  <div class="form-group row">
                    <label for="inputSuppEmail" class="col-sm-4 col-form-label">E-mail <a class="float-right"> : </a></label>
                    <div class="col-sm-8">
                ...
                <!-- Form-part input Supplier alamat -->
                  <div class="form-group row">
                    <label for="inputSuppAlamat" class="col-sm-4 col-form-label">Alamat <a class="float-right"> : </a></label>
                    <div class="col-sm-8">
