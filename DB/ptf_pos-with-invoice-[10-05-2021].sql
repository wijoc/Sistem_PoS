...
CREATE TABLE `installment_purchases` (
  ...
  `ip_periode_begin` int NOT NULL,
  `ip_periode_end` int NOT NULL,
  `ip_date` datetime NOT NULL,
  `ip_payment` decimal(10,2) NOT NULL,
  `ip_note_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ip_note_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ip_post_script` longtext COLLATE utf8mb4_unicode_ci
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `installment_sales` (
  ...
  `is_post_script` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `tb_customer` (
  `ctm_id` int NOT NULL,
  `ctm_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `trans_sales` (
  ...
  `ts_payment_method` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ts_delivery_method` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `ts_payment_status` varchar(2) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `det_trans_purchases`
  MODIFY `dtp_id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tb_category`
  MODIFY `ctgr_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `tb_customer`
--
ALTER TABLE `tb_customer`
  MODIFY `ctm_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
