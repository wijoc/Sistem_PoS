...
--
-- Host: localhost
-- Generation Time: Mar 22, 2021 at 07:11 AM
...
(13, 8, 1, '68500.00', '68500.00'),
(14, 2, 1, '74500.00', '74500.00'),
(16, 8, 1, '68000.00', '68000.00'),
(17, 9, 1, '66500.01', '66500.01'),
(18, 1, 1, '70000.00', '70000.00');
...
ALTER TABLE `trans_purchases`
  ADD PRIMARY KEY (`tp_id`),
  ADD UNIQUE KEY `tp_invoice_code` (`tp_invoice_code`);
...
--
ALTER TABLE `temp_purchases`
  MODIFY `tp_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
