...
--
-- Host: localhost
-- Generation Time: Feb 22, 2021 at 03:43 PM
...
(4, 'Q', 'Produk z', 10, '111.00', '111.00', '3', 1, 1, 1, 1, '1', NULL, 1),
...
--
ALTER TABLE `tb_product`
  MODIFY `prd_id` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tb_supplier`
  MODIFY `supp_id` int(3) NOT NULL AUTO_INCREMENT;
