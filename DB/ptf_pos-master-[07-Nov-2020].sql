...
--
-- Host: localhost
-- Generation Time: Nov 07, 2020 at 12:24 PM
...
CREATE TABLE `trans_expense` (
  ...
  `te_rek_id_fk` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `trans_expense` (`te_id`, `te_necessity`, `te_date`, `te_payment_method`, `te_payment`, `te_note`, `te_rek_id_fk`, `te_invoice`) VALUES
