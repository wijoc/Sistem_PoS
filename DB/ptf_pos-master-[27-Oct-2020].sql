...
--
-- Table structure for table `intallment_purchase`
--
...
--
-- Indexes for table `intallment_purchase`
--
ALTER TABLE `intallment_purchase`
...
--
ALTER TABLE `intallment_purchase`
  MODIFY `ip_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
