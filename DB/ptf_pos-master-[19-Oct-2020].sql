...
--
-- Table structure for table `det_installment_purchase`
--

CREATE TABLE `det_installment_purchase` (
  `ip_id` int(5) NOT NULL,
  `ip_trans_number` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ip_period` int(3) NOT NULL,
  `ip_due_date` date NOT NULL,
...
CREATE TABLE `det_trans_sales` (
  ...
  `dts_ts_fk` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `trans_purchase` (
  ...
  `tp_no_trans` varchar(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Indexes for table `det_installment_purchase`
--
ALTER TABLE `det_installment_purchase`
...
ALTER TABLE `trans_purchase`
  ADD PRIMARY KEY (`tp_id`),
  ADD UNIQUE KEY `tp_no_trans` (`tp_no_trans`);
...
--
-- AUTO_INCREMENT for table `det_installment_purchase`
--
ALTER TABLE `det_installment_purchase`
...
--
ALTER TABLE `tb_supplier`
  MODIFY `supp_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
