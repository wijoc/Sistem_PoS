...
--
-- Host: localhost
-- Generation Time: Nov 25, 2020 at 12:10 PM
...
CREATE TABLE `tb_customer` (
  ...
  `ctm_discount_price` decimal(10,2) DEFAULT NULL,
  `ctm_discount_percent` int(3) DEFAULT NULL,
  `ctm_discount_type` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tb_customer` (`ctm_id`, `ctm_name`, `ctm_phone`, `ctm_email`, `ctm_address`, `ctm_status`, `ctm_discount_price`, `ctm_discount_percent`, `ctm_discount_type`) VALUES
(1, 'Pelanggan A', '', '', '', 'Y', NULL, 0, 'prc'),
(2, 'Pelanggan B', '082232883299', 'alamatemail@email.com', 'Jl. jalan no. 6a rt 60 rw 99, kelurahan keluharjo, kecamatan kecamulyo, kota kotaiga', 'Y', '0.00', NULL, 'ptg'),
(3, 'Pelanggan C qwerty pro max ultra t fold 5g nfc', '', '', '', 'Y', NULL, 0, 'prc'),
(4, 'Pelanggan D', '', '', '', 'Y', NULL, 0, 'prc'),
(5, 'Pelanggan E', '', '', '', 'Y', NULL, 0, 'prc'),
(6, 'E', 'D', '', '', 'D', '10000.00', NULL, 'ptg'),
(7, 'Y', '', '', '', 'Y', NULL, 2, 'prc'),
(8, 'Pelanggan X', '', '', '', 'Y', '10000.00', NULL, 'ptg');
...
--
ALTER TABLE `tb_customer`
  MODIFY `ctm_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
