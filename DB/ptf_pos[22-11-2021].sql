...
--
-- Host: localhost
-- Generation Time: Nov 22, 2021 at 11:30 AM
...
INSERT INTO `tb_product` (`prd_id`, `prd_code`, `prd_name`, `prd_category_id_fk`, `prd_purchase_price`, `prd_selling_price`, `prd_unit_id_fk`, `prd_containts`, `prd_initial_g_stock`, `prd_initial_ng_stock`, `prd_initial_op_stock`, `prd_description`, `prd_image`, `prd_status`, `created_at`, `last_updated_at`, `created_by`, `last_updated_by`) VALUES
(2, '', 'C75 0,75 G-NET', NULL, '74500.00', '82000.00', 1, 1, 0, 0, 0, '', NULL, 0, '2021-06-21 02:31:28', NULL, 0, NULL),
...
--
ALTER TABLE `tb_category`
  MODIFY `ctgr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
